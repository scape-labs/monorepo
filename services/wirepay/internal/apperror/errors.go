// Package apperror defines the typed errors wirepay returns to handlers and RPC
...
//
// TODO: define the full set for wirepay.
type Code string
...
// Error is the typed error wirepay returns.
//
// TODO: implement.
type Error struct {
	Code    Code
