// Package apperror defines the typed errors emicro returns to handlers and RPC
...
//
// TODO: define the full set for emicro.
type Code string
...
// Error is the typed error emicro returns.
//
// TODO: implement.
type Error struct {
	Code    Code
