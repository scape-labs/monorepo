// Package app wires the flow-ussd service together.
//
...
// Service is the composition root for flow-ussd.
//
...
// Setup registers everything flow-ussd needs with the kit server.
//
